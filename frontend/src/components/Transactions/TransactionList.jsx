...
import {
  ...
  ListTransactionAPI,
} from "../../services/transaction/transactionServices";
...
const TransactionList = () => {
  ...
  const { data: transactions, refetch } = useQuery({
    ...
    queryKey: ["list-transaction", filter],
  });
  ...
  const handleDelete = (data) => {
    mutateAsync(data).then(() => refetch(data));
  };
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
        ...
        <div className='relative'>
          <select
            ...
            onChange={handleFilter}
            className='w-full p-2 rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 appearance-none text-black'
          >
